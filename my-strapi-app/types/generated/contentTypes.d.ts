...
export interface ApiConvocatoriaConvocatoria
  ...
  attributes: {
    ...
    carreras: Schema.Attribute.Relation<'manyToMany', 'api::carrera.carrera'>;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    departamentos: Schema.Attribute.Relation<
      'manyToMany',
    ...
    organizacion: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiOrganizacionOrganizacion
  extends Struct.CollectionTypeSchema {
